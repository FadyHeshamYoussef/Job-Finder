...
class _WorkTypeChooseViewState extends State<WorkTypeChooseView> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        containerColor = containerColor == Color(0xffFAFAFA) ? Color(0xffD6E4FF) : Color(0xffFAFAFA);
        borderColor = borderColor == Color(0xffD1D5DB) ? Color(0xff3366FF) : Color(0xffD1D5DB);
        setState(() {});
      },
      child: Container(
        width: 156.w,
