...
import '../applied_jobe_2/view.dart';
import '../applied_jobs_2/view.dart';

class AppliedJobe1View extends StatelessWidget {
  const AppliedJobe1View({super.key});
        ...
        child: Padding(
          ...
          child: ListView(
            ...
            children: [
              ...
              ButtonApp(text: "Next",color: Color(0xff3366FF),fontFamily:" " ,OnClick: (){navigateTo(context, AppliedJobe2View(),);}),
