...
import '../applied_job_secss/view.dart';
import '../setup_screen/view.dart';

class AppliedJobsScreen3View extends StatelessWidget {
  const AppliedJobsScreen3View({super.key});
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  ButtonApp(text: "Submit",color: Color(0xff3366FF),fontFamily:" " ,OnClick: (){navigateTo(context, SuccessfullyAppliedScreenView(),);}),
